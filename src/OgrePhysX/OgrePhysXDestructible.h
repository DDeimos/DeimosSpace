...
namespace OgrePhysX
{
	...
	protected:
		...
		public:
			SplitPart(Destructible *destructible, const Ogre::String &meshName, const Ogre::String &materialName);
			~SplitPart();
		...
		SplitPart* getOrCreatePart(const Ogre::String &meshName, const Ogre::String &materialName);
