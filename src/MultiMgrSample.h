#ifndef MULTI_MGR_SAMPLE_H
#define MULTI_MGR_SAMPLE_H

#include "BaseApplication.h"

class MultiMgrSample : public BaseApplication
{
public:
	MultiMgrSample(void);
	virtual ~MultiMgrSample(void);
...
protected:
	...
	void swap(Ogre::SceneManager *&first, Ogre::SceneManager *&second);
