...
bool AnimationSample::frameRenderingQueued(const Ogre::FrameEvent& fe)
{
...
bool AnimationSample::keyPressed(const OIS::KeyEvent& ke)
{
...
bool AnimationSample::keyReleased(const OIS::KeyEvent& ke)
{
  // CEGUI::GUIContext& context = CEGUI::System::getSingleton().getDefaultGUIContext();
...
bool AnimationSample::mouseMoved(const OIS::MouseEvent& me)
{
  // CEGUI::GUIContext& context = CEGUI::System::getSingleton().getDefaultGUIContext();
...
bool AnimationSample::mousePressed(const OIS::MouseEvent& me, OIS::MouseButtonID id)
{
  // CEGUI::GUIContext& context = CEGUI::System::getSingleton().getDefaultGUIContext();
...
bool AnimationSample::mouseReleased(const OIS::MouseEvent& me, OIS::MouseButtonID id)
{
  // CEGUI::GUIContext& context = CEGUI::System::getSingleton().getDefaultGUIContext();
...
void AnimationSample::windowResized(Ogre::RenderWindow* rw)
{
...
void AnimationSample::windowClosed(Ogre::RenderWindow* rw)
{
  if (rw == mWindow)
  {
    if (mInputMgr)
...
bool AnimationSample::configure()
{
...
void AnimationSample::chooseSceneManager()
{
  mSceneMgr = mRoot->createSceneManager(Ogre::ST_EXTERIOR_CLOSE);
}
 
void AnimationSample::createCamera()
{
...
void AnimationSample::createScene()
{
...
void AnimationSample::destroyScene()
{
}
 
void AnimationSample::createFrameListener()
{
...
void AnimationSample::createViewports()
{
...
void AnimationSample::setupResources()
{
  Ogre::ConfigFile cf;
...
void AnimationSample::createResourceListener()
{
}
 
void AnimationSample::loadResources()
{
  Ogre::ResourceGroupManager::getSingleton().initialiseAllResourceGroups();
}
 
/*bool AnimationSample::setupCEGUI()
{
...
bool AnimationSample::nextLocation()
{
  if (mWalkList.empty())
    return false;
